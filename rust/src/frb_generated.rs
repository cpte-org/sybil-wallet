...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1138757563;
...
189 => wire__crate__api__zns__zns_account_impl(port, ptr, rust_vec_len, data_len),
190 => wire__crate__api__zns__zns_decode_result_impl(port, ptr, rust_vec_len, data_len),
191 => wire__crate__api__zns__zns_export_key_impl(port, ptr, rust_vec_len, data_len),
192 => wire__crate__api__zns__zns_prepare_impl(port, ptr, rust_vec_len, data_len),
193 => wire__crate__api__zns__zns_random_secret_impl(port, ptr, rust_vec_len, data_len),
194 => wire__crate__api__zns__zns_read_call_impl(port, ptr, rust_vec_len, data_len),
195 => wire__crate__api__zns__zns_sign_impl(port, ptr, rust_vec_len, data_len),
196 => wire__crate__api__zns__zns_validate_unified_address_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
