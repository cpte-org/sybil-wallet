...
The bounded wallet experiment supports direct request/response exchanges on
Zcash testnet and regtest only. It has new, non-laboratory domain strings,
requires a caller-supplied full Unified Address validator. The direct exchange
parser still rejects introductions. These domains are experimental; they do not designate an
adopted Zcash standard. No mainnet, seed derivation, transport, backup, replay
...
strict signature profile, canonical bytes, 900-second requests and pinned
