...
abstract final class AppBackResolver {
  ...
  static const _routeLabels = <String, String>{
    ...
    '/people': 'People',
    '/people/add': 'Add someone',
    '/names': 'Manage my names',
    '/contacts/exchange': 'Contact exchange',
    '/contacts/introductions': 'Introductions',
    '/activity': 'Activity',
    '/activity/tx/:txid': 'Transaction',
    '/accounts': 'Accounts',
    '/settings': 'Settings',
    '/settings/security': 'Security and recovery',
