...
class FamiliarSavedPersonDetail extends StatefulWidget {
  const FamiliarSavedPersonDetail({
    super.key,
  ...
  @override
  State<FamiliarSavedPersonDetail> createState() =>
      _FamiliarSavedPersonDetailState();
}

class _FamiliarSavedPersonDetailState extends State<FamiliarSavedPersonDetail> {
  bool _busy = false;
  String? _error;
  @override
  Widget build(BuildContext context) {
    final person = widget.person, palette = FamiliarPalette.of(context);
    return Column(
