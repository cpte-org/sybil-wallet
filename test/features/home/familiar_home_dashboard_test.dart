...
String? headline(WidgetTester tester) => tester
    .widget<Text>(find.byKey(const ValueKey('familiar_available_balance')))
    .data;
...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        tester
            .getTopLeft(find.byKey(const ValueKey('familiar_balance_sync')))
            .dy,
        lessThan(
          tester
              .getTopLeft(
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: AppTheme(
          data: AppThemeData.light,
          child: Scaffold(
            body: FamiliarBalanceSyncStatus(
              sync: SyncState(
                isSyncComplete: true,
                scannedHeight: 100,
                chainTipHeight: 100,
