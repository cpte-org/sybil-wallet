...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.text('Link Sybil Desktop'), findsOneWidget);
  ...
  testWidgets('method cards use figma light theme colors and assets', (
    ...
    expect(_textColor(tester, 'Link Sybil Desktop'), colors.text.homeCard);
    expect(
  ...
  testWidgets('link desktop pushes the wallet link intro step', (tester) async {
    ...
    expect(find.text('Go to Settings → Link Sybil Mobile'), findsOneWidget);
    expect(
